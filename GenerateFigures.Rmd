...
This script generates all figures in the main text as well as supplementary figures. The script contains chunks named as the names of the corresponding
figures. 

Before executing other chunks in the script, execute the following commands manually:
...
memory : simulEpidemicSIRNN, simulEpidemicSIRSN, simulEpidemicSIRNS, simulEpidemicSIRSS. To load these objects, the corresponding .RData files should either be generated by simulating the ToyModel (read file SimulateToyModel.Rmd) or downloaded.
